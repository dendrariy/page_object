...
import string, random, time, pytest
...
def test_guest_can_add_product_to_basket(browser, link):
    ...
    product_page.check_product_name(name)
    product_page.check_product_price(price)
...
class TestUserAddToBasketFromProductPage():
    ...
    def setup(self, browser):
        ...
        login_page.open()
        login_page.register_new_user(email, ''.join(random.sample(password,10)))
